...
class EffectChain : public QObject {
  ...
  public:
    ...
    void deleteEffect(EffectPointer pEffect);
    void moveEffect(EffectPointer pEffect, int deltaPos);
  ...
  signals:
    ...
    // Signal that name of chain has changed by the ChainSlot in which it was 
    // loaded
