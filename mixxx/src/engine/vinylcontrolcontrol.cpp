...
VinylControlControl::VinylControlControl(const char* pGroup, ConfigObject<ConfigValue>* pConfig)
    ...
    m_pControlVinylSignalEnabled->setMidiButtonMode(ControlPushButton::TOGGLE);
}
