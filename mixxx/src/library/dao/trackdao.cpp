...
// hides a track from the library track collection. 
void TrackDAO::hideTrack(int id) {
    //qDebug() << "TrackDAO::hideTrack" << QThread::currentThread() << m_database.connectionName();
    Q_ASSERT(id >= 0);
    QSqlQuery query(m_database);
