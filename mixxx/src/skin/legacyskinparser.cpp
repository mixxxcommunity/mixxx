...
#include "widget/weffectchaineditor.h"
...
QWidget* LegacySkinParser::parseNode(QDomElement node, QWidget *pGrandparent) {
    ...
    } else if (nodeName == "EffectChainEditor") {       
        return parseEffectChainEditor(node);
...
QWidget* LegacySkinParser::parseEffectChainName(QDomElement node)
{
    ...
    WEffectChain *pEffectChain = new WEffectChain (chainNumber, m_pParent);
...
QWidget* LegacySkinParser::parseEffectChainEditor(QDomElement node)
{
                                                                                 
    WEffectChainEditor *pEffectChainEditor = new WEffectChainEditor (node, m_pParent);
                                                                                 
    //setupWidget (node, pEffectChainEditor);
    return pEffectChainEditor;
